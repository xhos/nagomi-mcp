...
const (
	...
	ReceiptServiceName = "nagomi.v1.ReceiptService"
)
...
const (
	...
	// UploadReceipt RPC.
	ReceiptServiceUploadReceiptProcedure = "/nagomi.v1.ReceiptService/UploadReceipt"
	// ReceiptServiceCreateReceiptProcedure is the fully-qualified name of the ReceiptService's
	// CreateReceipt RPC.
	ReceiptServiceCreateReceiptProcedure = "/nagomi.v1.ReceiptService/CreateReceipt"
	// ReceiptServiceListReceiptsProcedure is the fully-qualified name of the ReceiptService's
	// ListReceipts RPC.
	ReceiptServiceListReceiptsProcedure = "/nagomi.v1.ReceiptService/ListReceipts"
	// ReceiptServiceGetReceiptProcedure is the fully-qualified name of the ReceiptService's GetReceipt
	// RPC.
	ReceiptServiceGetReceiptProcedure = "/nagomi.v1.ReceiptService/GetReceipt"
	// ReceiptServiceUpdateReceiptProcedure is the fully-qualified name of the ReceiptService's
	// UpdateReceipt RPC.
	ReceiptServiceUpdateReceiptProcedure = "/nagomi.v1.ReceiptService/UpdateReceipt"
	// ReceiptServiceDeleteReceiptProcedure is the fully-qualified name of the ReceiptService's
	// DeleteReceipt RPC.
	ReceiptServiceDeleteReceiptProcedure = "/nagomi.v1.ReceiptService/DeleteReceipt"
	// ReceiptServiceRetryParseReceiptProcedure is the fully-qualified name of the ReceiptService's
	// RetryParseReceipt RPC.
	ReceiptServiceRetryParseReceiptProcedure = "/nagomi.v1.ReceiptService/RetryParseReceipt"
)

// ReceiptServiceClient is a client for the nagomi.v1.ReceiptService service.
...
// NewReceiptServiceClient constructs a client for the nagomi.v1.ReceiptService service. By default,
...
func NewReceiptServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ReceiptServiceClient {
	...
	receiptServiceMethods := v1.File_nagomi_v1_receipt_services_proto.Services().ByName("ReceiptService").Methods()
...
// UploadReceipt calls nagomi.v1.ReceiptService.UploadReceipt.
...
// CreateReceipt calls nagomi.v1.ReceiptService.CreateReceipt.
...
// ListReceipts calls nagomi.v1.ReceiptService.ListReceipts.
...
// GetReceipt calls nagomi.v1.ReceiptService.GetReceipt.
...
// UpdateReceipt calls nagomi.v1.ReceiptService.UpdateReceipt.
...
// DeleteReceipt calls nagomi.v1.ReceiptService.DeleteReceipt.
...
// RetryParseReceipt calls nagomi.v1.ReceiptService.RetryParseReceipt.
...
// ReceiptServiceHandler is an implementation of the nagomi.v1.ReceiptService service.
...
func NewReceiptServiceHandler(svc ReceiptServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/nagomi.v1.ReceiptService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedReceiptServiceHandler) UploadReceipt(context.Context, *connect.Request[v1.UploadReceiptRequest]) (*connect.Response[v1.UploadReceiptResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("nagomi.v1.ReceiptService.UploadReceipt is not implemented"))
}
...
func (UnimplementedReceiptServiceHandler) CreateReceipt(context.Context, *connect.Request[v1.CreateReceiptRequest]) (*connect.Response[v1.CreateReceiptResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("nagomi.v1.ReceiptService.CreateReceipt is not implemented"))
}
...
func (UnimplementedReceiptServiceHandler) ListReceipts(context.Context, *connect.Request[v1.ListReceiptsRequest]) (*connect.Response[v1.ListReceiptsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("nagomi.v1.ReceiptService.ListReceipts is not implemented"))
}
...
func (UnimplementedReceiptServiceHandler) GetReceipt(context.Context, *connect.Request[v1.GetReceiptRequest]) (*connect.Response[v1.GetReceiptResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("nagomi.v1.ReceiptService.GetReceipt is not implemented"))
}
...
func (UnimplementedReceiptServiceHandler) UpdateReceipt(context.Context, *connect.Request[v1.UpdateReceiptRequest]) (*connect.Response[v1.UpdateReceiptResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("nagomi.v1.ReceiptService.UpdateReceipt is not implemented"))
}
...
func (UnimplementedReceiptServiceHandler) DeleteReceipt(context.Context, *connect.Request[v1.DeleteReceiptRequest]) (*connect.Response[v1.DeleteReceiptResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("nagomi.v1.ReceiptService.DeleteReceipt is not implemented"))
}
...
func (UnimplementedReceiptServiceHandler) RetryParseReceipt(context.Context, *connect.Request[v1.RetryParseReceiptRequest]) (*connect.Response[v1.RetryParseReceiptResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("nagomi.v1.ReceiptService.RetryParseReceipt is not implemented"))
}
