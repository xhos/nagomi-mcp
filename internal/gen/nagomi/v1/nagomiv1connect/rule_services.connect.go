...
const (
	...
	RuleServiceName = "nagomi.v1.RuleService"
)
...
func NewRuleServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) RuleServiceClient {
	...
	ruleServiceMethods := v1.File_nagomi_v1_rule_services_proto.Services().ByName("RuleService").Methods()
...
// GetRule calls nagomi.v1.RuleService.GetRule.
...
// CreateRule calls nagomi.v1.RuleService.CreateRule.
...
// UpdateRule calls nagomi.v1.RuleService.UpdateRule.
...
// DeleteRule calls nagomi.v1.RuleService.DeleteRule.
...
func (UnimplementedRuleServiceHandler) ListRules(context.Context, *connect.Request[v1.ListRulesRequest]) (*connect.Response[v1.ListRulesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("nagomi.v1.RuleService.ListRules is not implemented"))
}
...
func (UnimplementedRuleServiceHandler) GetRule(context.Context, *connect.Request[v1.GetRuleRequest]) (*connect.Response[v1.GetRuleResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("nagomi.v1.RuleService.GetRule is not implemented"))
}
...
func (UnimplementedRuleServiceHandler) CreateRule(context.Context, *connect.Request[v1.CreateRuleRequest]) (*connect.Response[v1.CreateRuleResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("nagomi.v1.RuleService.CreateRule is not implemented"))
}
...
func (UnimplementedRuleServiceHandler) UpdateRule(context.Context, *connect.Request[v1.UpdateRuleRequest]) (*connect.Response[v1.UpdateRuleResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("nagomi.v1.RuleService.UpdateRule is not implemented"))
}
