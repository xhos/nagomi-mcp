...
const (
	...
	DashboardServiceName = "nagomi.v1.DashboardService"
)
...
const (
	...
	DashboardServiceGetDashboardSummaryProcedure = "/nagomi.v1.DashboardService/GetDashboardSummary"
	...
	DashboardServiceGetMonthlyComparisonProcedure = "/nagomi.v1.DashboardService/GetMonthlyComparison"
	// DashboardServiceGetTopCategoriesProcedure is the fully-qualified name of the DashboardService's
	// GetTopCategories RPC.
	DashboardServiceGetTopCategoriesProcedure = "/nagomi.v1.DashboardService/GetTopCategories"
	// DashboardServiceGetTopMerchantsProcedure is the fully-qualified name of the DashboardService's
	// GetTopMerchants RPC.
	DashboardServiceGetTopMerchantsProcedure = "/nagomi.v1.DashboardService/GetTopMerchants"
	// DashboardServiceGetSpendingTrendsProcedure is the fully-qualified name of the DashboardService's
	// GetSpendingTrends RPC.
	DashboardServiceGetSpendingTrendsProcedure = "/nagomi.v1.DashboardService/GetSpendingTrends"
	...
	DashboardServiceGetFinancialSummaryProcedure = "/nagomi.v1.DashboardService/GetFinancialSummary"
	...
	DashboardServiceGetCategorySpendingComparisonProcedure = "/nagomi.v1.DashboardService/GetCategorySpendingComparison"
	// DashboardServiceGetNetWorthHistoryProcedure is the fully-qualified name of the DashboardService's
	// GetNetWorthHistory RPC.
	DashboardServiceGetNetWorthHistoryProcedure = "/nagomi.v1.DashboardService/GetNetWorthHistory"
...
func NewDashboardServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) DashboardServiceClient {
	...
	dashboardServiceMethods := v1.File_nagomi_v1_dashboard_services_proto.Services().ByName("DashboardService").Methods()
...
// GetMonthlyComparison calls nagomi.v1.DashboardService.GetMonthlyComparison.
...
// GetTopCategories calls nagomi.v1.DashboardService.GetTopCategories.
...
// GetTopMerchants calls nagomi.v1.DashboardService.GetTopMerchants.
...
// GetSpendingTrends calls nagomi.v1.DashboardService.GetSpendingTrends.
...
// GetFinancialSummary calls nagomi.v1.DashboardService.GetFinancialSummary.
...
// GetCategorySpendingComparison calls nagomi.v1.DashboardService.GetCategorySpendingComparison.
...
// GetNetWorthHistory calls nagomi.v1.DashboardService.GetNetWorthHistory.
...
// GetCurrencies calls nagomi.v1.DashboardService.GetCurrencies.
...
func (UnimplementedDashboardServiceHandler) GetDashboardSummary(context.Context, *connect.Request[v1.GetDashboardSummaryRequest]) (*connect.Response[v1.GetDashboardSummaryResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("nagomi.v1.DashboardService.GetDashboardSummary is not implemented"))
}
...
func (UnimplementedDashboardServiceHandler) GetMonthlyComparison(context.Context, *connect.Request[v1.GetMonthlyComparisonRequest]) (*connect.Response[v1.GetMonthlyComparisonResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("nagomi.v1.DashboardService.GetMonthlyComparison is not implemented"))
}
...
func (UnimplementedDashboardServiceHandler) GetTopCategories(context.Context, *connect.Request[v1.GetTopCategoriesRequest]) (*connect.Response[v1.GetTopCategoriesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("nagomi.v1.DashboardService.GetTopCategories is not implemented"))
}
...
func (UnimplementedDashboardServiceHandler) GetTopMerchants(context.Context, *connect.Request[v1.GetTopMerchantsRequest]) (*connect.Response[v1.GetTopMerchantsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("nagomi.v1.DashboardService.GetTopMerchants is not implemented"))
}
...
func (UnimplementedDashboardServiceHandler) GetSpendingTrends(context.Context, *connect.Request[v1.GetSpendingTrendsRequest]) (*connect.Response[v1.GetSpendingTrendsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("nagomi.v1.DashboardService.GetSpendingTrends is not implemented"))
}
...
func (UnimplementedDashboardServiceHandler) GetFinancialSummary(context.Context, *connect.Request[v1.GetFinancialSummaryRequest]) (*connect.Response[v1.GetFinancialSummaryResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("nagomi.v1.DashboardService.GetFinancialSummary is not implemented"))
}
...
func (UnimplementedDashboardServiceHandler) GetCategorySpendingComparison(context.Context, *connect.Request[v1.GetCategorySpendingComparisonRequest]) (*connect.Response[v1.GetCategorySpendingComparisonResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("nagomi.v1.DashboardService.GetCategorySpendingComparison is not implemented"))
}
...
func (UnimplementedDashboardServiceHandler) GetNetWorthHistory(context.Context, *connect.Request[v1.GetNetWorthHistoryRequest]) (*connect.Response[v1.GetNetWorthHistoryResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("nagomi.v1.DashboardService.GetNetWorthHistory is not implemented"))
}
