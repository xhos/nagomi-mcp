...
const (
	...
	CategoryServiceName = "nagomi.v1.CategoryService"
)
...
const (
	...
	// ListCategories RPC.
	CategoryServiceListCategoriesProcedure = "/nagomi.v1.CategoryService/ListCategories"
	// CategoryServiceGetCategoryProcedure is the fully-qualified name of the CategoryService's
	// GetCategory RPC.
	CategoryServiceGetCategoryProcedure = "/nagomi.v1.CategoryService/GetCategory"
	// CategoryServiceCreateCategoryProcedure is the fully-qualified name of the CategoryService's
	// CreateCategory RPC.
	CategoryServiceCreateCategoryProcedure = "/nagomi.v1.CategoryService/CreateCategory"
	// CategoryServiceUpdateCategoryProcedure is the fully-qualified name of the CategoryService's
	// UpdateCategory RPC.
	CategoryServiceUpdateCategoryProcedure = "/nagomi.v1.CategoryService/UpdateCategory"
	// CategoryServiceDeleteCategoryProcedure is the fully-qualified name of the CategoryService's
	// DeleteCategory RPC.
	CategoryServiceDeleteCategoryProcedure = "/nagomi.v1.CategoryService/DeleteCategory"
)

// CategoryServiceClient is a client for the nagomi.v1.CategoryService service.
...
// NewCategoryServiceClient constructs a client for the nagomi.v1.CategoryService service. By
...
func NewCategoryServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) CategoryServiceClient {
	...
	categoryServiceMethods := v1.File_nagomi_v1_category_services_proto.Services().ByName("CategoryService").Methods()
...
// ListCategories calls nagomi.v1.CategoryService.ListCategories.
...
// GetCategory calls nagomi.v1.CategoryService.GetCategory.
...
// CreateCategory calls nagomi.v1.CategoryService.CreateCategory.
...
// UpdateCategory calls nagomi.v1.CategoryService.UpdateCategory.
...
// DeleteCategory calls nagomi.v1.CategoryService.DeleteCategory.
...
// CategoryServiceHandler is an implementation of the nagomi.v1.CategoryService service.
...
func NewCategoryServiceHandler(svc CategoryServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/nagomi.v1.CategoryService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedCategoryServiceHandler) ListCategories(context.Context, *connect.Request[v1.ListCategoriesRequest]) (*connect.Response[v1.ListCategoriesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("nagomi.v1.CategoryService.ListCategories is not implemented"))
}
...
func (UnimplementedCategoryServiceHandler) GetCategory(context.Context, *connect.Request[v1.GetCategoryRequest]) (*connect.Response[v1.GetCategoryResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("nagomi.v1.CategoryService.GetCategory is not implemented"))
}
...
func (UnimplementedCategoryServiceHandler) CreateCategory(context.Context, *connect.Request[v1.CreateCategoryRequest]) (*connect.Response[v1.CreateCategoryResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("nagomi.v1.CategoryService.CreateCategory is not implemented"))
}
...
func (UnimplementedCategoryServiceHandler) UpdateCategory(context.Context, *connect.Request[v1.UpdateCategoryRequest]) (*connect.Response[v1.UpdateCategoryResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("nagomi.v1.CategoryService.UpdateCategory is not implemented"))
}
...
func (UnimplementedCategoryServiceHandler) DeleteCategory(context.Context, *connect.Request[v1.DeleteCategoryRequest]) (*connect.Response[v1.DeleteCategoryResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("nagomi.v1.CategoryService.DeleteCategory is not implemented"))
}
