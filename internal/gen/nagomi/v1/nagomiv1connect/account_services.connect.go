...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/xhos/nagomi-mcp/internal/gen/nagomi/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	AccountServiceName = "nagomi.v1.AccountService"
)
...
// NewAccountServiceClient constructs a client for the nagomi.v1.AccountService service. By default,
...
func NewAccountServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) AccountServiceClient {
	...
	accountServiceMethods := v1.File_nagomi_v1_account_services_proto.Services().ByName("AccountService").Methods()
...
// ListAccounts calls nagomi.v1.AccountService.ListAccounts.
...
// GetAccount calls nagomi.v1.AccountService.GetAccount.
...
// CreateAccount calls nagomi.v1.AccountService.CreateAccount.
...
// UpdateAccount calls nagomi.v1.AccountService.UpdateAccount.
...
// DeleteAccount calls nagomi.v1.AccountService.DeleteAccount.
...
// AddAccountAlias calls nagomi.v1.AccountService.AddAccountAlias.
...
// RemoveAccountAlias calls nagomi.v1.AccountService.RemoveAccountAlias.
...
// SetAccountAliases calls nagomi.v1.AccountService.SetAccountAliases.
...
// FindAccountByAlias calls nagomi.v1.AccountService.FindAccountByAlias.
...
// MergeAccounts calls nagomi.v1.AccountService.MergeAccounts.
...
// AccountServiceHandler is an implementation of the nagomi.v1.AccountService service.
...
func NewAccountServiceHandler(svc AccountServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/nagomi.v1.AccountService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedAccountServiceHandler) ListAccounts(context.Context, *connect.Request[v1.ListAccountsRequest]) (*connect.Response[v1.ListAccountsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("nagomi.v1.AccountService.ListAccounts is not implemented"))
}
...
func (UnimplementedAccountServiceHandler) GetAccount(context.Context, *connect.Request[v1.GetAccountRequest]) (*connect.Response[v1.GetAccountResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("nagomi.v1.AccountService.GetAccount is not implemented"))
}
...
func (UnimplementedAccountServiceHandler) CreateAccount(context.Context, *connect.Request[v1.CreateAccountRequest]) (*connect.Response[v1.CreateAccountResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("nagomi.v1.AccountService.CreateAccount is not implemented"))
}
...
func (UnimplementedAccountServiceHandler) UpdateAccount(context.Context, *connect.Request[v1.UpdateAccountRequest]) (*connect.Response[v1.UpdateAccountResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("nagomi.v1.AccountService.UpdateAccount is not implemented"))
}
...
func (UnimplementedAccountServiceHandler) DeleteAccount(context.Context, *connect.Request[v1.DeleteAccountRequest]) (*connect.Response[v1.DeleteAccountResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("nagomi.v1.AccountService.DeleteAccount is not implemented"))
}
...
func (UnimplementedAccountServiceHandler) AddAccountAlias(context.Context, *connect.Request[v1.AddAccountAliasRequest]) (*connect.Response[v1.AddAccountAliasResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("nagomi.v1.AccountService.AddAccountAlias is not implemented"))
}
...
func (UnimplementedAccountServiceHandler) RemoveAccountAlias(context.Context, *connect.Request[v1.RemoveAccountAliasRequest]) (*connect.Response[v1.RemoveAccountAliasResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("nagomi.v1.AccountService.RemoveAccountAlias is not implemented"))
}
...
func (UnimplementedAccountServiceHandler) SetAccountAliases(context.Context, *connect.Request[v1.SetAccountAliasesRequest]) (*connect.Response[v1.SetAccountAliasesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("nagomi.v1.AccountService.SetAccountAliases is not implemented"))
}
...
func (UnimplementedAccountServiceHandler) FindAccountByAlias(context.Context, *connect.Request[v1.FindAccountByAliasRequest]) (*connect.Response[v1.FindAccountByAliasResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("nagomi.v1.AccountService.FindAccountByAlias is not implemented"))
}
...
func (UnimplementedAccountServiceHandler) MergeAccounts(context.Context, *connect.Request[v1.MergeAccountsRequest]) (*connect.Response[v1.MergeAccountsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("nagomi.v1.AccountService.MergeAccounts is not implemented"))
}
